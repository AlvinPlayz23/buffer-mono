import { complete, getModel } from "#buffer-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "buffer-agent";
import { DynamicBorder, getMarkdownTheme } from "buffer-agent";
import { Container, Markdown, matchesKey, Text } from "#buffer-tui";
