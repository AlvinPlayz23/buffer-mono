...
import { Agent, type AgentMessage, type ThinkingLevel } from "#buffer-agent-core";
import type { Message, Model } from "#buffer-ai";
...
export interface CreateAgentSessionOptions {
	...
	/** Built-in tools to use. Default: build mode tools [read, bash, edit, write, ask, task] */
	tools?: Tool[];
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	const defaultActiveToolNames: ToolName[] = ["read", "bash", "edit", "write", "ask", "task"];
