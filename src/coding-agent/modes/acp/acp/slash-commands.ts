...
/**
 * File-based slash command (mirrors buffer prompt template semantics).
 */
...
/**
 * Load prompt templates from buffer prompt directories.
 *  - user:    ~/.buffer/agent/prompts/**\/*.md
 *  - project: <cwd>/.buffer/prompts/**\/*.md
 */
