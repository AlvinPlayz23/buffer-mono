...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "#buffer-tui";
...
const THEME_KEY = Symbol.for("buffer-agent:theme");
...
export function getSettingsListTheme(): import("#buffer-tui").SettingsListTheme {
	return {
