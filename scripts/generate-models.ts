...
import { Api, KnownProvider, Model } from "../src/buffer-ai/types.js";
...
`;
	...
	// Write file
	writeFileSync(join(packageRoot, "src/buffer-ai/models.generated.ts"), output);
	console.log("Generated src/buffer-ai/models.generated.ts");
