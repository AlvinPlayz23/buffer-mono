...
import { stream } from "../../src/buffer-ai/stream.js";
import type { Context } from "../../src/buffer-ai/types.js";
...
describe("Cache Retention (PI_CACHE_RETENTION)", () => {
	...
	describe("Anthropic Provider", () => {
		...
		it("should not add ttl when baseUrl is not api.anthropic.com", async () => {
			...
			const { streamAnthropic } = await import("../../src/buffer-ai/providers/anthropic.js");
	...
	describe("OpenAI Responses Provider", () => {
		...
		it("should not set prompt_cache_retention when baseUrl is not api.openai.com", async () => {
			...
			const { streamOpenAIResponses } = await import("../../src/buffer-ai/providers/openai-responses.js");
