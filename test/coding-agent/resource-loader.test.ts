...
import { DefaultResourceLoader } from "../../src/coding-agent/core/resource-loader.js";
import { SettingsManager } from "../../src/coding-agent/core/settings-manager.js";
import type { Skill } from "../../src/coding-agent/core/skills.js";
	...
	describe("extension conflict detection", () => {
		it("should detect tool conflicts between extensions", async () => {
			...
			writeFileSync(
				...
				`
import type { ExtensionAPI } from "buffer-agent";
